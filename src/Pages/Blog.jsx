        ...
        <div className="home">
            <div className="container" style={{maxWidth: '60%'}}>
                ...
                <ul className="blog-list">
                    ...
                    <li><a target="_blank" rel="noreferrer" href="https://deetercesler.medium.com/the-ten-commandments-of-clean-code-89b22a6f01d1">The 10 Commandments of Clean Code</a></li>
                    <li><a target="_blank" rel="noreferrer" href="https://deetercesler.medium.com/using-graphql-with-react-2778750a768d">Use GraphQL with React: So Easy, a Junior Dev Can Do It</a></li>
