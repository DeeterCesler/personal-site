            ...
            <PsychedelicBackground>
                <div className="shadow-background-work">
                    <div className="tech-container">
                        ...
                        <section>
                            <h3>TECH</h3>
                            {/* make another section for my ios app: https://apps.apple.com/us/app/norse-flashcards/id6743998805?l=es-MX&platform=iphone */}
                            <div className="item">
                                <h3><a className="link" target="_blank" rel="noreferrer" href="https://apps.apple.com/us/app/norse-flashcards/id6743998805?l=es-MX&platform=iphone">Norse Flashcards</a>: an iOS app</h3>
                                <p>Learn the old Norse runic alphabet for free. It's available on the App Store and is totally <a className="link" target="_blank" rel="noreferrer" href="https://github.com/DeeterCesler/norse">open-sourced</a>.</p>
                            </div>
                            <div className="item">
